                                ...
                                @forelse($orderProducts as $index => $orderProduct)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                            ...
                                            @else
                                                <input type="number" step="1" name="orderProducts[{{$index}}][quantity]" class="w-full p-1 border border-indigo-500 rounded-md focus:outline-none" wire:model="orderProducts.{{$index}}.quantity" />
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                            @if($orderProduct['is_saved'])
                                            ...
                                            @endif
                                            <button class="px-4 py-2 ml-1 text-xs text-red-500 uppercase bg-red-200 border border-transparent rounded-md hover:text-red-700 hover:bg-red-300" wire:click.prevent="removeProduct({{$index}})">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
